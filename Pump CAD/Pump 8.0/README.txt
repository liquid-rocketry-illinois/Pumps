This is the folder containing the assembly of pump V8.0, as well as all of the associated files as of 9/17/2024.

-------------------------------------------------------------------

The organization of this folder is as follows:

Pump 8.0 -> Rotational/Stationary Parts -> Custom/Imported Parts -> Part Types -> Part Attributes -> Part Files
...
Pump 8.0
	...
	Static Parts
		Custom Static Parts
			304 Stainless Steel
				PumpBearingCap_8.0
				PumpHousingBottom_8.0
				PumpHousingTop_8.0

			PTFE
				PumpLabyrinthSeal_8.0
...
The pump V8.0 CAD was made by Charlie Pluth.
